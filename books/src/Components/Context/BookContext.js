...
export default BookContextProvider;
    ...
    // -Başlangıç değeri ver ve export et.
    // -İlgili componente import et.
    // -context type yardımıyla contexti ilgili componente ata.
    ...
    // 2- Provider ---> Consumer
    // -Class component oluştur. Veriyi state içerisine koy.
    // -Contexte ait Provider ile statete bulunan veriyi al.
    // -Parent child ilişkisi kur. {this.props.children}
    // -Verinin gönderileceği componentte contexti import et.
    // -Render içerisinde Consumer ile Providerdan gelen veriyi yakala.
